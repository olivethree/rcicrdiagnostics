...
`[SKIP]` on colour-capable consoles), and a short explanation. The
"Skipped checks" list at the bottom tells you which checks didn't run —
usually because the required input (an RT column, the stimulus `.RData`,
etc.) wasn't passed to `run_all_checks()`.
