...
- **Example datasets**: the `data-raw/` folder contains stubs for
  `generate_example_2ifc.R` and `generate_example_briefrc.R`. Running
  these will populate `inst/extdata/` with a reproducible synthetic
  RC dataset you can practise on.
- **Pipeline-specific quickstarts**: once the CI-generation–dependent
  checks land, separate `quickstart-2ifc` and `quickstart-briefrc`
  vignettes will walk through the full pipeline end to end.
- **A Quarto ebook version**: this tutorial is written in R Markdown
  and maps cleanly to Quarto; a standalone ebook version is planned.

## 11. References

Brinkman, L., Goffin, S., van de Schoot, R., Visser, I., Derks, D., & Dotsch, R. (2019). Quantifying the informational value of classification images. *Behavior Research Methods*, *51*, 2059–2073. https://doi.org/10.3758/s13428-019-01232-2
